    ...
    while (TableauPlayers.length > 1) {
        ...
        if ((Attaquant != Oldattaquant) && (Attaquant != Defenseur)) {
            if ((TableauPlayers[Attaquant].vie > 0) && (TableauPlayers[Defenseur].vie > 0)) {
                Attaquer();
                Oldattaquant = TableauPlayers[Attaquant];
            } else if (TableauPlayers[Defenseur].vie > 0) {
                console.log("%cLe personnage défenseur " + TableauPlayers[Defenseur].nom + " est mort !!", "color : yellow");
                alert("Victoire de " + TableauPlayers[Attaquant].nom);
                TableauPlayers.splice(Attaquant, 1);
                console.log(TableauPlayers);
            } if (TableauPlayers[Attaquant].vie > 0) {
                console.log("%cLe personnage attaquant " + TableauPlayers[Attaquant].nom + " est mort !!", "color : yellow");
                alert("Victoire de " + TableauPlayers[Defenseur].nom);
...
Attaquer = function () {
    ...
    if ((TableauPlayers[Attaquant].rage >= 20) && (TableauPlayers[Attaquant].attaquespe2 == true)) {
    ...
    if (TableauPlayers[Attaquant].attaque > TableauPlayers[Defenseur].defense) {
